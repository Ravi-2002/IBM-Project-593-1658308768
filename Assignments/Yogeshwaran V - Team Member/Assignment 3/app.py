...
COS_API_KEY_ID =  "7NkdSJx3mTEwL1EoSpRM78LjMlmDdZMwTjXp3QOkLvTO"
COS_INSTANCE_CRN =  "crn:v1:bluemix:public:cloud-object-storage:global:a/fe6b8308837048b5a5ce591c885ba4e5:39fd125d-22a6-4055-b3cd-42c726c92b11::"
...
@app.route('/')
def index():
    files = get_bucket_contents('shahrinbanu-ibm')
